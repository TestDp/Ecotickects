        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading text-center"><h3>Políticas de Habeas Data</h3></div>

                    <div class="panel-body">

                            <div class="boxed">
                                <!-- breadcrumbs -->
                                <div class="page-title"><span class="heading-t"></span><h1></h1><span class="heading-b3" style="margin-top:px; margin-bottom:px; background-color:#ffffff"></span></div>			<article id="post-4778" class="single-post post-4778 page type-page status-publish hentry">

                                    <div class="entry">
                                        <h4><strong>¿Qué es el derecho de Hábeas Data?</strong></h4>
                                        ...
                                        <blockquote><p>La Corte Constitucional lo definió como el derecho que otorga la facultad al titular de datos personales de exigir de las administradoras de esos datos el acceso, inclusión, exclusión, corrección, adición, actualización y certificación de los datos, así como la limitación en las posibilidades de su divulgación, publicación o cesión, de conformidad con los principios que regulan el proceso de administración de datos personales. Asimismo, ha señalado que este derecho tiene una naturaleza autónoma que lo diferencia de otras garantías con las que está en permanente relación, como los derechos a la intimidad y a la información.</p></blockquote>
                                        <h4><strong>¿Quién es el titular de la información?</strong></h4>
                                        ...
                                        <h4><strong>¿Quién es la fuente de información?</strong></h4>
                                        ...
                                        <h4><strong>¿Qué se entiende por vínculo de cualquier otra índole?</strong></h4>
                                        ...
                                        <h4><strong>¿Quién es el operador de la información?</strong></h4>
                                        ...
                                        <h4><strong>¿Quién es el usuario de la información?</strong></h4>
                                        ...
                                        <h4><strong>¿Qué es un dato personal?</strong></h4>
                                        ...
                                        <blockquote><p>Los datos serán públicos cuando la ley o la Constitución así lo establezcan, y cuando no sean de aquellos clasificados como semiprivados o privados. Son públicos, entre otros, los datos contenidos en documentos públicos, sentencias judiciales debidamente ejecutoriadas y los relativos al estado civil de las personas.</p></blockquote>
                                        ...
                                        <h4><strong>¿Qué es el principio de finalidad?</strong></h4>
                                        ...
                                        <h4><strong>¿En qué consiste la circulación restringida?</strong></h4>
                                        ...
                                        <h4><strong>¿Qué es la temporalidad de la información?</strong></h4>
                                        ...
                                        <h4><strong>¿Qué es el principio de interpretación integral de derechos constitucionales?</strong></h4>
                                        ...
                                        <h4><strong>¿En qué consiste el principio de seguridad?</strong></h4>
                                        ...
                                        <h4><strong>¿Qué es el principio de confidencialidad?</strong></h4>
                                        ...
                                        <h4><a href="http://www.sic.gov.co/manejo-de-informacion-personal" target="_blank">VER MÁS</a></h4>
                                    </div>
