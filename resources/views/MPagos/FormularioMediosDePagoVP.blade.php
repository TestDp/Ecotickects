@section('FomularioMediosDePago')
        <div id="divTC">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a class="navbar-brand" onclick="AgregarVlrPagoTC('DINERS')" style="cursor:pointer;">
                        <img style="height: auto !important;" src="../img/icono_diners.png" data-active-url="../img/icono_visa.png" alt="" width="100%" height="100%"/>
                    </a>
                </div>
                <div class="col-md-3">
                    <a class="navbar-brand" onclick="AgregarVlrPagoTC('CODENSA')" style="cursor:pointer;">
