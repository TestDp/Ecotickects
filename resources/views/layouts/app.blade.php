              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="{{ url('/') }}"><img class="brand-logo-dark" src="{{ asset('images/logo-default.png') }}" srcset="{{ asset('images/logo-default@2x.png 2x') }}" alt="Ecotickets"/><img class="brand-logo-light" src="{{ asset('images/logo-inverse.png') }}" srcset="{{ asset('images/logo-inverse@2x.png 2x') }}" alt="Ecotickets"/></a>
                  </div>
                </div>
