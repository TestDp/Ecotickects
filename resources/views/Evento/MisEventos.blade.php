                    ...
                    <div class="panel-body">
                       ...
                       <!-- @endif-->
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#EventosProximo"
                                   role="tab" aria-controls="home"
                                   aria-selected="true">Eventos Próximos</a>
                            </li>
                            <li>
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#EventosPasados" role="tab"
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade in active" id="EventosProximo" role="tabpanel"
                                 aria-labelledby="home-tab">
                                <div style="overflow-x:auto;">
                                    <table style="border-collapse: collapse !important; border-spacing: 0 !important; width: 100% !important;"
                                           id="TablaListaEventos" class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th>
                                                Id
                                            ...
                                            <tr>
                                              ...
                                              <!--  @endif-->
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-blue ripple trial-button"
                                                       href="{{ url('/Liquidacion',['idEvento' => $evento->id ]) }}">Liquidación</a>
                                                </td>
                            ...
                            <div class="tab-pane fade" id="EventosPasados" role="tabpanel"
                                 aria-labelledby="profile-tab">
                                <!-- poner la tabla de eventos pasados-->
                                <div style="overflow-x:auto;">
                                    <table style="border-collapse: collapse !important; border-spacing: 0 !important; width: 100% !important;"
                                           id="TablaListaEventos2" class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th>
                                                Id
                                        ...
                                        @foreach($ListaEventosPasados["eventosPasados"] as $eventoPasado)
                                            <tr>
                                               ...
                                               <!-- @endif-->
                                                ...
                                                <td>
                                                    <a class="btn btn-blue ripple trial-button"
                                                       href="{{ url('/Liquidacion',['idEvento' => $eventoPasado->id ]) }}">Liquidación</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
            ...
            var table = $('#TablaListaEventos').DataTable({
                ...
                buttons: {
                    ...
                    buttons: [
                        {
                            extend: 'excel',
                            text: '<p style="color: green !important; font-size: 20px; text-align: center;"><img src="http://estebanquinteroc.com/wp-content/uploads/2017/10/icono-excel.png"></img>Exportar lista</p>'
                        }
                    ]
                },
                language: {
