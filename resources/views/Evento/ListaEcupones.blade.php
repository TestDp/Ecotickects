                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a href="{{url('FormularioAsistente', ['idEvento' => $cupon->id ])}}">{{ $cupon->Lugar_Evento }}</a></h3>
                                        <h3 class="product-name"><a href="{{url('FormularioAsistente', ['idEvento' => $cupon->id ])}}">{{ $cupon->ciudad->Nombre_Ciudad }}</a></h3>
							...
							<div class="col-md-4 col-xs-6">							
								<div class="product">
									...
									<div class="product-body">
                                        ...
                                        <h3 class="product-name"><a href="#">{{ $cupon->ciudad->Nombre_Ciudad }}</a></h3>
