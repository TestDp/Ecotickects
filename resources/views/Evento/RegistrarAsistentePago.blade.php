                    ...
                    @else
                        <div id="formAsistente">
                            ...
                            <div class="row">							
                                ...
                                <div class="col-md-3">                                  
                                    <input  onclick="validarCodigoPromocional({{$ElementosArray["EventoId"]}})" class="btn btn-blue ripple trial-button"  name="Validador" value="Validar Código"   />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                    ...
                    @else
                        <div id="formAsistente">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <button  onclick="validarCodigoPromocional({{$ElementosArray["EventoId"]}})" class="btn btn-blue ripple trial-button"  name="Validador" value="Validar Codigo"   />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
