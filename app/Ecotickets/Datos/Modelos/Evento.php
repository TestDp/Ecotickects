...
class Evento extends Model
{
    ...
    protected $fillable =['Nombre_Evento','Lugar_Evento','Fecha_Evento','Fecha_Inicial_Registro','Fecha_Final_Registro','Tipo_Evento','user_id','Ciudad_id','FlyerEvento','numeroAsistentes','SolicitarPIN'];
